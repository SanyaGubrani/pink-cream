...
function HeroSection({ data }: HeroProps) {
  return (
    <section className="bg-background relative w-full pb-32 md:pt-12 xl:pt-6 overflow-hidden">
      <div className="mx-auto flex max-w-7xl flex-col-reverse px-4 sm:px-6 md:flex-row md:items-center md:justify-between md:gap-10 lg:px-8">
        <div className="flex w-full flex-col items-center text-center md:items-start md:text-left">
          ...
          <div className="relative inline-block">
            <h1 className="font-cormorant text-primary mb-4 text-4xl leading-[1.2] font-semibold tracking-tight sm:text-5xl md:text-[2.6rem] md:max-w-lg lg:text-6xl">
              {data.heading}
            </h1>
            {/* scribbles */}
            <Image
      ...
      {/* SHAPE DIVIDER */}
      <div className="white-shape-divider">
